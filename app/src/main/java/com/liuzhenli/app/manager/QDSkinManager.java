...
public class QDSkinManager {
    ...
    public static void changeSkin(int index) {
        QMUISkinManager.defaultInstance(AppApplication.getInstance()).changeSkin(index);
        PreferenceManager.getInstance(AppApplication.getInstance()).setSkinIndex(index);
    }

    public static int getCurrentSkin() {
        return QMUISkinManager.defaultInstance(AppApplication.getInstance()).getCurrentSkin();
    }
}
